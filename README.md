...
- `/emchantment <name> [level]` - наложить чар на предмет в руке.
- `/cenchant <name> [level]` - алиас для `/emchantment`.
- `/cenchantment <name> [level] [player]` - выдать книгу кастомного чара.
...
- `magnetism` - складывает дроп в инвентарь и помогает подбирать предметы рядом.
- `autosmelt` - переплавляет уже рассчитанный сервером дроп.
